...
/**
 * Reads custom coding standards from CODING_STANDARDS.md in working directory or environment variable.
 */
export function loadCustomCodingStandards(): string {
...
export async function getGitDiff(): Promise<string> {
  ...
  if (!isRepo) {
    console.warn('[AI Reviewer] Current working directory is not a Git repository. Cannot perform git diff.');
    return '';
  }
  ...
  try {
    ...
    console.warn(`[AI Reviewer] Local HEAD diff failed:`, (err as Error).message);
  }
...
/**
 * Creates OpenAI client instance supporting both OpenAI standard and Azure OpenAI endpoints.
 */
...
/**
 * Sends git diff to OpenAI API for structured analysis.
 */
export async function analyzeDiffWithAI(diff: string, customStandards: string): Promise<CodeReviewComment[]> {
...
/**
 * Posts comments to Azure DevOps Pull Request.
 */
export async function postCommentsToAzureDevOps(comments: CodeReviewComment[]): Promise<void> {
...
/**
 * Main AI Code Reviewer Execution Function
 */
export async function runAIReviewer(): Promise<void> {
  console.log('=====================================================');
  console.log('    @mycompany/core-engine: AI PR Code Reviewer     ');
  console.log('=====================================================');

  const customStandards = loadCustomCodingStandards();
  if (customStandards) {
    console.log('[AI Reviewer] Loaded custom coding standards from working directory.');
  } else {
    console.log('[AI Reviewer] No custom CODING_STANDARDS.md found. Using default security/clean code rules.');
  }
